...
router.post('/', (0, auth_1.requireRole)('admin', 'manager'), recipeController.createRecipe);
router.post('/:id/scale', recipeController.scaleRecipe);
// PUT routes (require admin or manager)
router.put('/:id', (0, auth_1.requireRole)('admin', 'manager'), recipeController.updateRecipe);
// DELETE routes (require admin)
router.delete('/:id', (0, auth_1.requireRole)('admin'), recipeController.deleteRecipe);
